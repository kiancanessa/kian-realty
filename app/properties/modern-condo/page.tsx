...
export const metadata: Metadata = {
  title: "Modern Condo for Rent in Playas de Rosarito",
  description: "2-bed, 2-bath condo for rent in Playas de Rosarito, Baja California — $1,800/mo. Shared pool & gym, 5 minutes to the beach. Contact El Casa Rosarito.",
  alternates: { canonical: "/properties/modern-condo" },
  openGraph: {
    title: "Modern Condo for Rent in Playas de Rosarito",
    description: "2-bed, 2-bath condo for rent in Playas de Rosarito — $1,800/mo. 5 minutes to the beach.",
    images: ["/images/properties/condo/1-exterior.jpg"],
    type: "website",
  },
};
...
const JSON_LD = {
  ...
  name: "Modern Condo, Playas de Rosarito",
  description: "2-bed, 2-bath condo for rent in Playas de Rosarito, Baja California with shared pool and gym.",
  url: "https://elcasarosaritogroup.com/properties/modern-condo",
  image: "https://elcasarosaritogroup.com/images/properties/condo/1-exterior.jpg",
