...
export const translations = {
  en: {
    ...
    property: {
      ...
      viewLargerMap: "Open in Google Maps",
    ...
    about: {
      ...
      team: [
        ...
        { name: "Luis Jaramillo", role: "Real Estate Advisor", photo: "/images/team/luis.jpg", bio: "Real estate advisor licensed as a Professional Real Estate Agent by the Government of Baja California (TIJ20190055). He guides buyers and sellers across Rosarito and Tijuana." },
    ...
    associates: {
      eyebrow: "Associates",
      title: "We work alongside",
      lead: "Agencies and businesses we trust across the region. Together we offer a wider selection of properties along the Baja coast.",
      visit: "Visit site",
      items: [
        { slug: "jarames", name: "Jarames Group", tagline: "Homes and condos in Rosarito and Tijuana", url: "https://www.jaramesgroup.com", logo: "/images/associates/jarames.png" },
        { slug: "lemus", name: "Grupo Lemus Realty", tagline: "Real estate in Playas de Rosarito", url: "https://lemusrealty.com", logo: "/images/associates/lemus.png" },
      ],
    },
    testimonials: {
  ...
  es: {
    ...
    property: {
      ...
      viewLargerMap: "Abrir en Google Maps",
    ...
    about: {
      ...
      team: [
        ...
        { name: "Luis Jaramillo", role: "Asesor Inmobiliario", photo: "/images/team/luis.jpg", bio: "Asesor inmobiliario con Licencia de Agente Profesional Inmobiliario del Gobierno de Baja California (TIJ20190055). Acompaña a compradores y vendedores en Rosarito y Tijuana." },
    ...
    associates: {
      eyebrow: "Asociados",
      title: "Trabajamos junto a",
      lead: "Agencias y negocios de confianza en la región. Juntos ofrecemos una selección más amplia de propiedades en la costa de Baja California.",
      visit: "Visitar sitio",
      items: [
        { slug: "jarames", name: "Jarames Group", tagline: "Casas y condominios en Rosarito y Tijuana", url: "https://www.jaramesgroup.com", logo: "/images/associates/jarames.png" },
        { slug: "lemus", name: "Grupo Lemus Realty", tagline: "Bienes raíces en Playas de Rosarito", url: "https://lemusrealty.com", logo: "/images/associates/lemus.png" },
      ],
    },
    testimonials: {
