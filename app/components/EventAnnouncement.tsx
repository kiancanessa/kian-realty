...
const SEEN_KEY = "eventAnnouncementSeen_expo2026";
const EMAIL = "ampirosarito2024@gmail.com";
  ...
  return (
    ...
    >
        ...
        <div style={{ padding: "32px 32px 32px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12, marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0, marginLeft: "auto" }}>
              ...
              <button onClick={dismiss} aria-label={t.event.close}
          ...
          <div className="event-layout" style={{ display: "grid", gridTemplateColumns: "1fr", gap: 24 }}>
            ...
            <div>
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 22 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.88rem", color: "rgb(var(--ink))", fontWeight: 500 }}>{t.event.dates}</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <MapPin size={15} color="rgb(var(--accent))" />
                  <span style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.85rem", color: "rgba(var(--ink),0.65)" }}>{t.event.venue}</span>
                </div>
              </div>
              ...
              <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.58rem", letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(var(--ink),0.45)", marginBottom: 10 }}>
                {t.event.activitiesTitle}
              </div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {t.event.activities.map((a, i) => (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ ...GLASS, borderRadius: 18, padding: "16px 18px" }}>
                ...
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.7rem", color: "rgb(var(--accent))", marginBottom: 8 }}>{t.event.price}</div>
                <p style={{ fontFamily: "'Jost', sans-serif", fontSize: "0.66rem", color: "rgba(var(--ink),0.45)", lineHeight: 1.5 }}>
                  {t.event.priceNote}
                </p>
              </div>

              <a href={`mailto:${EMAIL}?subject=${encodeURIComponent("Rosarito Investment Forum 2026")}`}
              ...
              <button onClick={() => setVideoOpen(true)}
                ...
                <PlayCircle size={15} /> {t.event.watchVideo}
              </button>
            </div>
          </div>
        </div>
      ...
      {videoOpen && (
        ...
        >
          <button onClick={() => setVideoOpen(false)} aria-label={t.event.close}
          ...
          <video
            src="/videos/rosarito-investment-forum-2026.mp4"
            controls
            autoPlay
